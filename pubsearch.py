...
#Basically made the raw_input fields look a bit better. Some spacing down in the os.system for "theharvester" commands were a bit awkward.
#The triple quotes I took out except for down in one of them, because I didn't want to reformat it all since it works for now.
	...
	if ans=="0":
		...
		while ans:
			try:
				...
				print 'You do not have The Harvester installed.'
				break 	
...
#This is the beginning for Metagoofil
	if ans=="2":
		...
		while ans:
			...
			limit=raw_input("To how many searches would you like to limit yourself to? (Default 200)\n")
...
#Main Menu
			if upgrade=="9":
					...
					#http://github.com/fawkes-picks/ is a dope ass place to check out.
